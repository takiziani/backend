...
async function run(gaol, duration) {
    ...
    const msg = `respond in a json format  ,give a plan to achive the goal of ${gaol} in this time frame :${duration} days,the plan should be in the form of tasks with a task for every day of the time frame meening ${duration} tasks,it is important that the json fllow this format: {"tasks:["task":"",date:"",point:""]},note that the date here is the due date of the task,the point are based on how hard the task is chose form 1 to a 100.it will be today is ${year}/${month}/${day}`
